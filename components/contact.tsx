...
export default function Contact() {
  ...
  return (
    ...
    <p className="text-gray-700 -mt-6 dark:text-white">Please contact me directly at <a className='font-bold dark:text-white' href='mailto:elmubaraqy10@gmail.com'>
    ...
    <form className="mt-10 flex flex-col
      ...
      >
        ...
        <button type="submit" className="group flex items-center justify-center gap-2 h-[3rem] w-[8rem] bg-gray-900 text-white rounded-full outline-none transition-all 
         focus:scale-110 hover:scale-110 active:scale-105 dark:bg-white dark:bg-opacity-20"
        >
